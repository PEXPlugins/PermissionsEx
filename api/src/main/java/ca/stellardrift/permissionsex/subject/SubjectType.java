...
public interface SubjectType {
     ...
     * @since 2.0.0
     */
    void setTypeInfo(SubjectTypeDefinition<?> def);
     ...
     * @since 2.0.0
     */
    SubjectTypeDefinition<?> getTypeInfo();
     ...
     * @since 2.0.0
     */
    CompletableFuture<CalculatedSubject> get(String identifier);
     ...
     * @since 2.0.0
     */
    SubjectDataCache transientData();
     ...
     * @since 2.0.0
     */
    SubjectDataCache persistentData();
