...
import ca.stellardrift.permissionsex.gradle.kotlinx
...
subprojects {
    ...
    dependencies {
        ...
        "implementation"(kotlinx("coroutines-reactor", Versions.KOTLIN_COROUTINES))
        "implementation"(kotlinx("coroutines-core", Versions.KOTLIN_COROUTINES))
    }
}
