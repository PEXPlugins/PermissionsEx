...
final class FabricMessageFormatter extends MessageFormatter {

    FabricMessageFormatter(final MinecraftPermissionsEx<?> manager) {
        super(manager);
    }
    ...
    protected @Nullable <I> String friendlyName(final SubjectRef<I> reference) {
        ...
        return associated instanceof Nameable ? ((Nameable) associated).getName().asString() : super.friendlyName(reference);
    }
