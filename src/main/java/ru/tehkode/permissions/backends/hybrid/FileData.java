...
public class FileData implements PermissionsUserData, PermissionsGroupData {
	...
	public Map<String, List<String>> getPermissionsMap() {
		...
		if (worldsSection != null) {
			for (String world : worldsSection.getKeys(false)) {
				List<String> worldPermissions = this.node.getStringList(HybridBackend.buildPath("worlds", world, "permissions"));
				if (commonPermissions != null) {
	...
	protected static String formatPath(String worldName, String node, String value) {
		String path = HybridBackend.buildPath(node, value);

		if (worldName != null && !worldName.isEmpty()) {
			path = HybridBackend.buildPath("worlds", worldName, path);
		}
