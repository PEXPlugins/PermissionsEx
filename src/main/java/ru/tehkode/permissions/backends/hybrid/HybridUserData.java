 ...
 */
public class HybridUserData implements PermissionsUserData, PermissionsGroupData {
    private String identifier;
    private final Type type;
    private final HybridBackend backend;

    // Cache
    private final AtomicBoolean virtual = new AtomicBoolean(true);

    public HybridUserData(String identifier, Type type, HybridBackend backend) {
    ...
    public void setPermissions(List<String> permissions, String worldName) {
        ...
        try (SQLConnection conn = backend.getSQL()) {
            ...
            if (permissions.size() > 0) {
                ...
                for (int i = permissions.size() - 1; i >= 0; i--) { // insert in
                                                                    // reverse
                                                                    // order
    ...
    public Set<String> getWorlds() {
        ...
        // this.node.getConfigurationSection("worlds");
